...
public final class NeverLandTownyJustice extends JavaPlugin {
    ...
    @Override public void onDisable(){if(task!=null)task.cancel();if(expansion!=null)expansion.unregister();getServer().getServicesManager().unregisterAll(this);if(townCommand)TownyCommandAddonAPI.removeSubCommand(TownyCommandAddonAPI.CommandType.TOWN,"justice");}
}
