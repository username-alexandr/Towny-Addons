...
public final class DependencyVersions {
    public static final Map<String,String> MINIMUM=Map.of("NeverLandTownyBuilds","0.8.5","NeverLandTownyResources","0.1.5","NeverLandTownyPopulation","0.1.7","NeverLandTownyUpkeep","0.1.3","NeverLandTownyTrade","0.1.9","NeverLandTownyTaxes","0.1.2","NeverLandTownyQuests","0.1.0");
