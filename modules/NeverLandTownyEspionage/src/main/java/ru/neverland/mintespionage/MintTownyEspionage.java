...
public final class MintTownyEspionage extends JavaPlugin {
    ...
    @Override public void onEnable(){
        ...
        boolean papi=PlaceholderHook.register(this,towny,service);ru.neverland.core.ActivityAdmin.attach(this,"townyespionage","mintespionage.admin",service::adminTargets);
service.startScheduler();long autosave=Math.max(20,getConfig().getLong("scheduler.autosave-seconds",60)*20);getServer().getScheduler().runTaskTimer(this,repository::saveIfDirty,autosave,autosave);
