# NeverLandTownyArchaeology 0.1.6
...
Каталог содержит 28 артефактов и 10 коллекций. Для всех 11 Чудес Света настроены отдельные музейные требования; 12 реликвий и шесть коллекций посвящены новой очереди Чудес версии 0.7.0.
