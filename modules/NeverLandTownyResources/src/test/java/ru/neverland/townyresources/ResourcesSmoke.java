...
public final class ResourcesSmoke {
    ...
    public static void main(String[] args)throws Exception{
        ...
        System.out.println("ResourcesSmoke OK: eight resources, 91 profiles, 1000 city cycles, conservation, reserves, priorities, shortages, capacity, district fractions and durable restart");
    }
}
