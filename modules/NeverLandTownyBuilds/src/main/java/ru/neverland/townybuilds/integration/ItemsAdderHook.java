...
public final class ItemsAdderHook {
    ...
    public void reload() {
        ...
        try {
            ...
            available = true;
            plugin.getLogger().info("ItemsAdder обнаружен: пользовательские иконки GUI включены.");
        } catch (ReflectiveOperationException exception) {
            plugin.getLogger().warning("ItemsAdder обнаружен, но его API недоступен: " + exception.getMessage());
        }
    }
